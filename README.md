...
Sou formado em Análise e Desenvolvimento de Sistemas e atualmente estou aprofundando meus conhecimentos em computação em nuvem por meio do programa AWS re/Start.

Minha trajetória é marcada pela busca constante por transformar desafios técnicos em soluções que gerem impacto real. Acredito que tecnologia vai além de ferramentas: ela deve facilitar a vida das pessoas, resolver problemas e gerar valor para quem a utiliza.

- 🚀 Foco Atual: Infraestrutura AWS, Linux, Python e Redes.
- 🎯 Objetivo: Conquistar a certificação AWS Certified Cloud Practitioner.
- 💡 Diferencial: Facilidade em ouvir necessidades, colaborar com equipes e persistir diante de desafios complexos.
...
🌟 Projeto em Destaque: App Rádio Câmara Sete Lagoas

Desenvolvi e publiquei na Google Play Store o aplicativo oficial da Rádio Câmara FM 103.5, contribuindo para ampliar o acesso da população às informações institucionais e fortalecer a transparência e a participação cidadã.

Principais Informações

- ✅ Status: Finalizado e em Produção (Versão 1.0.5)
- 📱 Compatibilidade: Android 15 (API 35)
- 💻 Tecnologias: Kotlin, Android Studio e ferramentas de apoio à produtividade e automação
- 🔒 Repositório: Privado por questões institucionais
...
- Miniplayer integrado às notificações
...
Desenvolvidas ao longo da minha experiência profissional, atuação como freelancer e projetos na área de tecnologia:
